...
import { saveUserData } from "../../utility/auth";
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (data) {
                localStorage.setItem('userData', JSON.stringify(data)); // ✅ Save user object
                localStorage.setItem('authToken', data.token);          // ✅ Optionally save token
            }
                    ...
                    <div className="mx-auto md:mx-0 max-w-md">
                        ...
                        <form onSubmit={handleLogin}>
                            <div className="mt-7" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <input className="w-full h-12 md:h-14 bg-white dark:bg-transparent border border-bdr-clr focus:border-primary p-4 outline-none duration-300" type="email" placeholder="Enter your email address" required value={email}
                            ...
                            <div data-aos="fade-up" data-aos-delay="600">
                                <button type="submit" disabled={loading} className="btn btn-theme-solid mt-[15px]" data-text="Login"><span>{loading ? 'Logging in...' : 'Login'}</span></button>
                            </div>
                        </form>
                        {
                            message && (
