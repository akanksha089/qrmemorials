...
function Index() {
    ...
    useEffect(() => {
        const fetchPackage = async () => {
            try {
                const response = await fetch(`${API_BASE_URL}/api/v1/api-packages`, {
                    headers: {
            ...
            <div className="s-py-100-50 overflow-hidden">
                <div className="container-fluid">
                    <div className="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
                        ...
                        <h3 className="leading-none mt-4 md:mt-6 text-2xl md:text-3xl">Features</h3>
                        <p className="mt-3">Soul Link features deep emotional connection, shared experiences, mutual growth, empathy, and spiritual synchronization between individuals. </p>
                    </div>
            ...
            <div className="s-py-50-100">
                <div className="container-fluid">
                    <div className="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
                        ...
                        <h3 className="leading-none mt-4 md:mt-6 text-2xl md:text-3xl">Preserving Legacies with Soul Link</h3>
                        <p className="mt-3"> Ensures memories, values, and achievements endure, inspiring future generations with lasting cultural significance.</p>
                    </div>
                    <div className="max-w-[1720px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8" data-aos="fade-up" data-aos-delay="100">
                        {packages && packages.slice(0, 3).map((item, index) => {
                            return (
                    ...
                    <div className="max-w-[1720px] mx-auto">
                        <div className="max-w-[1186px] ml-auto">
                            <div className="max-w-xl mb-8 md:mb-12">
                                ...
                                <h3 className="leading-none mt-4 md:mt-6 text-2xl md:text-3xl uppercase">how it works</h3>
                                <p className="mt-3">Soul Link legacies honors the past, safeguards heritage, and passes wisdom, stories, and values to future generations. </p>
                            </div>
