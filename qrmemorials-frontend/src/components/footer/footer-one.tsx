                ...
                <div className="container-fluid">
                    ...
                    <div className="max-w-[1722px] mx-auto flex items-start justify-between gap-10 s-pb-100 flex-wrap lg:flex-nowrap footer-wrapper">
                        ...
                        <div className="lg:max-w-[366px] sm:w-[45%] lg:w-full flex items-start justify-between gap-10 footer-inner-wrapper">
                           <div>
                                <h4 className="text-white leading-none mb-5 md:mb-6 text-xl md:text-2xl">Get To Know Us</h4>
                        ...
                        <div className="lg:max-w-[522px] w-full sm:text-center -order-1 lg:order-none">
                            ...
                            <p className="mt-4 text-white-light max-w-[522px] sm:mx-auto">Keeping the memory of loved ones alive can be a comforting and healing part of the grieving process. It allows you to celebrate their life, acknowledge the love you shared, and ensure their legacy continues </p>
                        ...
                        <div className="lg:max-w-[460px] sm:w-[45%] lg:w-full flex items-end justify-end gap-10 footer-inner-wrapper">
                            {/* <div>
                                <h4 className="text-white leading-none mb-5 md:mb-6 text-xl md:text-2xl">Get To Know Us</h4>
                                <ul className="text-white leading-none flex flex-col gap-4">
                                    {footerLink1.map((item,index)=>{
