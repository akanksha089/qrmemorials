...
export default function NavbarThree() {
  ...
  return (
    <div className={`header-area absolute bg-white dark:bg-title dark:bg-dark  left-0 right-0 tp-0 lg:top-[10px] xl:top-[15px] z-50 before:absolute before:h-full before:top-0 before:left-0 before:z-[-1] before:bg-white dark:before:bg-title before:w-[190px] sm:before:w-[250px] lg:before:w-[22%] xl:before:w-[19%] ${scroll ? 'sticky-header bg-white' : 'lg:bg-transparent'}`}>
